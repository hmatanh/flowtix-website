      ...
      <div className="absolute inset-0 flex flex-col">
        ...
        >
          ...
          <div className="flex items-center gap-3 text-[#A98046]">
            ...
            <span className="inline-flex items-center gap-1 text-[10px] tabular-nums px-2 py-1 rounded-full" style={{ background: "rgba(249,115,22,0.10)", color: "#FED7AA" }}>
        ...
        <div className="flex-1 grid grid-cols-[1fr_360px] overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 70% 70% at 50% 40%, #F97316 0%, #C2410C 60%, #7C2D12 100%)",
            }}
          >
            {/* Brand-mood eyebrow */}
            ...
            >
              <defs>
                <linearGradient id="coatGrad" x1="0" y1="0" x2="0" y2="1">
                  ...
                  <stop offset="60%" stopColor="#1A0F04" />
          ...
          >
            <div>
              ...
              <div className="flex items-baseline gap-2.5 mt-2">
                <span className="font-black text-[#F97316] tabular-nums" style={{ fontSize: 22 }}>
                  $189
                </span>
            ...
            <p className="text-[#FED7AA] text-[12px] leading-relaxed">
            ...
            <div>
              ...
              <div className="flex items-center gap-2.5">
                {[
                  { name: "Bracken", color: "#7C2D12", active: true },
        ...
        >
          {[
            { name: "Field Overcoat", price: "$189", tint: "linear-gradient(135deg, #7C2D12 0%, #1A0F04 100%)" },
            ...
            { name: "Camel Topcoat", price: "$262", tint: "linear-gradient(135deg, #A8551F 0%, #2B1A07 100%)" },
          ].map((p) => (
            <div
              key={p.name}
            ...
            >
              ...
              >
                <svg viewBox="0 0 100 140" className="h-full">
                  <path
                    ...
                    strokeWidth="1"
                  />
                  <line x1="50" y1="25" x2="50" y2="130" stroke="rgba(249,115,22,0.20)" strokeWidth="0.6" />
                </svg>
              </div>
              <div className="flex items-center justify-between">
                ...
                <span className="text-[#F97316] text-[11px] font-bold tabular-nums">
                  {p.price}
                </span>
              </div>
